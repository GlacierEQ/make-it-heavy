...
from semantic_claim_innovation import (
    ...
    ReceiptLineageSemanticClaimAdaptiveWorkerLoop,
)
...
class SemanticClaimFirewallTests(unittest.TestCase):
    def test_turn9_semantic_loop_preserves_receipt_lineage(self):
        self.assertTrue(
            issubclass(
                ReceiptLineageSemanticClaimAdaptiveWorkerLoop,
    ...
    def test_atomic_source_supported_claim_passes(self):
        ...
        self.assertEqual(result["relation_counts"][SOURCE_ENTAILS_CLAIM], 1)
    ...
    def test_broad_observed_claim_is_quarantined(self):
        ...
        self.assertEqual(result["relation_counts"][SOURCE_INSUFFICIENT], 1)
    ...
    def test_reviewed_negation_conflict_escalates(self):
        ...
        self.assertEqual(result["relation_counts"][SOURCE_CONTRADICTS_CLAIM], 1)
